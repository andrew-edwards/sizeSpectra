...
gap.barplot.cust(hLlin.list$counts,
                 gap=c(9,980),
...
TODO: Check if can use some further functionalisation from later
...
# Llin method (results calculated above in hLlin.list)
...
TODO GOT TO HERE, have taken out the calculation stuff so just leave the
plotting here, then maybe make that into a function to simplify the
vignette. Later figures may be better suited to generalising.
...
legJust(c("(b) LT",
          paste("slope=", signif(hLT.slope, 3), sep=""),
          paste("b=", signif(hLT.slope, 3), sep="")),
        inset=inset)
...
plot(hLTplus1.log10.mids,
     hLTplus1.log10.counts,
...
legJust(c("(c) LTplus1",
          paste("slope=", signif(hLTplus1.slope, 3), sep=""),
          paste("b=", signif(hLTplus1.slope, 3), sep="")),
        inset=inset)
