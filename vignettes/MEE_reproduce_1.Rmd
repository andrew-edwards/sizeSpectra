...
This vignette reproduces the figures and tables in the MEE paper that are based
on the original single simulated data set. See the paper for details. The aim of the vignette is
to enable users to reproduce the results so that they can see what functions are
appropriate for their own data, and perform further analyses as required.
