...
|:----- | :--------------- | -----------: |-----:  |---:  |-----------:  |--------------------:|
|Llin   | -                | `r qqtab(Llin.rep.df$slope, dig=2, quants=c(0.05, 0.95), latex=FALSE)` |
