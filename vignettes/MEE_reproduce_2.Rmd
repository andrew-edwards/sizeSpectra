...
## Figure 3 - TODO standard histogram of a random sample from a bounded power-law distribution

TODO Generate random sample from bounded power-law distribution, where the resulting
...
# TODO - takes too long to run with 10000 to make vignette, so make me into a
# data object and save as part of package. Still traceable.
n = 1000                  # sample size
...
for(iii in 1:num.reps)
{
  # if(iii %in% seq(1000, num.reps, 1000)) print(paste("iii = ", iii))
                                        # show progress, but comment out for vignette
