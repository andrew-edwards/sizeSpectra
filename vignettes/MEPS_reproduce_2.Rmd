...
## Setting $x_{min}=1$ but only sampling data above the cutoff value of 16 (Figures S.37 and S.38 and Table S.5)

Similarly, the simulation results obtained from setting $x_{min}=1$ again but
