...
Here is the code to build the movie, but is commented out (since causes Travis
to fail). Trick is to run it, save the resulting .html aas
`MESP_IBTS_all_animate.html`, then comment this and re-run and push to GitHub.
```{r, eval=FALSE}
