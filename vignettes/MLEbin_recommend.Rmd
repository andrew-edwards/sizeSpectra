...
spectrum, as people are used to seeing this type of plot. If the data are only
...
express as the vertical extent of the grey box in the figure below for each bin.

The horizontal range of each bin is simply shown as the horizontal extent of the
grey box for that bin; for bin $j$ this is just $w_j$ to $w_{j+1}$.
