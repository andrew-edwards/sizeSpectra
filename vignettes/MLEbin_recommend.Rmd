...
line shows the range of body sizes, with its value
...
in that bin; for example, all $n = 1000$ values are $\geq$ the minimum of
the first (left-most) bin, so that bin is at $1000$ on the y-axis. The vertical
span of each grey rectangle shows the possible range of the number of
individuals with body mass $\geq$ the
body mass of individuals in that bin (horizontal
span is the same as for the green lines). The text
