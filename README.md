...
Here is a movie showing fits to 30 years of International Bottom Trawl Survey data fit and plotted using our new methods, where the bin structure is properly accounted for (see [2] for full explanations):
