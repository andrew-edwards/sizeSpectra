...
##'
##' Simulate multiple data sets from a known individual size distribution, bin
##' them using linears of width 1, 5 and 10, and bins that progressively double
##' in width, and then fit each data set using the MLEmid and MLEbin likelihood
##' methods. As in Figures 4, 5, and S.35-S.38, and Tables S.3-S.5 of MEPS
##' paper. See simulate-data2.R (TODO maybe?) and MEPS_reproduce_2.Rmd vignette
##'
##' @param n sample size of each simulated data set
##' @param b.known
##' @param xmin.known
##' @param xmax.known
##' @param num.reps
...
set.seed(seed)              # Same seed as for original simulations in
                          #  first manuscript.
